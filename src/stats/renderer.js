...
export async function renderStatsCard(stats, options = {}) {
  ...
  if (!hideRank && stats.rank) {
    ...
    if (rankIcon === 'avatar' && stats.avatarUrl) {
      ...
      svg.push(`<text x="-5" y="-4" alignment-baseline="central" dominant-baseline="central" text-anchor="middle" class="rank-text" font-size="14">TOP</text>`);
      svg.push(`<text x="-5" y="12" alignment-baseline="central" dominant-baseline="central" text-anchor="middle" class="rank-text" font-size="10">${stats.rank.percentile}%</text>`);
    } else {
      svg.push(`<g class="rank-text">`);
      svg.push(`<text x="-5" y="3" alignment-baseline="central" dominant-baseline="central" text-anchor="middle">${stats.rank.level || 'C+'}</text>`);
      svg.push(`</g>`);
