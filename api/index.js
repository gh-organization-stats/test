...
import { renderStatsCard, renderErrorCard } from '../src/stats/renderer.js';
...
const locale = validLocales.includes(req.query.locale) ? req.query.locale : 'en';
    ...
    res.send(svg);
        ...
        const svg = renderErrorCard(error.message, {
      ...
      hide_border: req.query.hide_border,
      border_radius: req.query.border_radius
        });
    res.setHeader('Content-Type', 'image/svg+xml');
